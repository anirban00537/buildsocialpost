...
function Dashboard() {
  return (
    <div className="flex h-screen overflow-hidden bg-cardBackground">
      <div className="flex flex-col flex-1 h-full overflow-hidden">
        ...
        <main className="flex-1 max-h-full p-5 ml-[390px]  bg-cardBackground overflow-hidden overflow-y-scroll main-bg">
          <div>
            <EditorBody />
          </div>
        </main>
