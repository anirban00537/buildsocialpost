              ...
              {group.posts.map((post, postIndex) => (
                ...
                >
                  <CardContent className="p-4 flex items-center space-x-4">
                    <div className="flex-shrink-0 w-28 text-xs font-medium text-gray-600 
                    ...
                    <div className="flex-grow">
                      <p className="text-sm text-gray-700 line-clamp-2 group-hover:line-clamp-none 
                                   transition-all duration-300 group-hover:text-gray-900">
                        {post.content}
                      </p>
                      {type === "failed" && post.errorMessage && (
